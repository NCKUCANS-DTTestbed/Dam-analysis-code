...
data = pd.read_csv('Dataset_TFIDF.csv')
data = data[['Protocol1','Protocol2','Protocol3','TFfun','Trela_fun','Trela_pro','Answer']]
data = data.head(40000)
data['Trela_fun'] = data['Trela_fun']/10
data['TFfun'] = data['TFfun']*3.5
...
group = cluster.fit_predict(data[['Protocol1','Protocol2','Protocol3','Trela_fun','TFfun']])
...
data.ix[data.Group == 0, 'Result'] = 0
data.ix[data.Group == 1, 'Result'] = 1
data.ix[data.Group == 2, 'Result'] = 1
data.ix[data.Group == 3, 'Result'] = 1
data.ix[data.Group == 4, 'Result'] = 0#
data.ix[data.Group == 5, 'Result'] = 1
data.ix[data.Group == 6, 'Result'] = 1
data.ix[data.Group == 7, 'Result'] = 1
data.ix[data.Group == 8, 'Result'] = 0#
data.ix[data.Group == 9, 'Result'] = 1
data.ix[data.Group == 10, 'Result'] = 1
data.ix[data.Group == 11, 'Result'] = 0#
data.ix[data.Group == 12, 'Result'] = 1
data.ix[data.Group == 13, 'Result'] = 1
data.ix[data.Group == 14, 'Result'] = 0#
data.ix[data.Group == 15, 'Result'] = 0#
data.ix[data.Group == 16, 'Result'] = 1
data.ix[data.Group == 17, 'Result'] = 0#
data.ix[data.Group == 18, 'Result'] = 0#
data.ix[data.Group == 19, 'Result'] = 1
data.ix[data.Group == 20, 'Result'] = 1
data.ix[data.Group == 21, 'Result'] = 1
data.ix[data.Group == 22, 'Result'] = 1
data.ix[data.Group == 23, 'Result'] = 1
