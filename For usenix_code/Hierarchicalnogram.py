...
group = cluster.fit_predict(data[['Protocol1','Protocol2','Protocol3','Trela_pro','Trela_fun']])
...
data.ix[data.Group == 0, 'Result'] = 1  #
data.ix[data.Group == 1, 'Result'] = 0  #
