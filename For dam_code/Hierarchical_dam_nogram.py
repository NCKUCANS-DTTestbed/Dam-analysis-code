...
group = cluster.fit_predict(data[['Protocol1','Protocol2','Protocol3','IP_src1','IP_src2','Trela_fun','Trela_pro']])
...
data.to_csv('Dataset_dam_nogram.csv')
